...
// Hər bir modul üçün xüsusi ikonlar
const Ikonlar = {
  Davamiyyet: () => (
  ...
  Hesabat: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"/><path d="M18.7 8a6 6 0 0 0-6 0"/><path d="M12.7 14a6 6 0 0 0-6 0"/><path d="M12 20v-6"/></svg>
  ),
  Monitorinq: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2.5 2v6h6L2.5 2zM2.5 22v-6h6L2.5 22zM21.5 2v6h-6L21.5 2zM21.5 22v-6h-6L21.5 22z"/><path d="M12 8v8"/><path d="M8 12h8"/></svg>
  ),
  Netice: () => (
      ...
      <main className="module-selection">
        <div className="module-grid">
          ...
          <div className="module-card" onClick={() => handleNavigate('form')}>
            ...
            <div className="card-text">
              <h4>MTM üzrə monitorinq</h4>
              <p>Məktəbəqədər təhsil müəssisələrinin yoxlanılması.</p>
            </div>
          </div>
          ...
          <div className="module-card" onClick={() => handleNavigate('reports')}>
            ...
            <div className="card-text">
              <h4>MTM üzrə monitorinq nəticələri</h4>
              <p>Məktəbəqədər təhsil müəssisələrində aparılmış monitorinqlərin hesabatları.</p>
            </div>
          </div>
