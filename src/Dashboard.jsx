...
const Ikonlar = {
  ...
  Hesabat: () => ( <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"/><path d="M18.7 8a6 6 0 0 0-6 0"/><path d="M12.7 14a6 6 0 0 0-6 0"/><path d="M12 20v-6"/></svg> ),
  Monitorinq: () => ( <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2.5 2v6h6L2.5 2zM2.5 22v-6h6L2.5 22zM21.5 2v6h-6L21.5 2zM21.5 22v-6h-6L21.5 22z"/><path d="M12 8v8"/><path d="M8 12h8"/></svg> ),
  Netice: () => ( <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="m10 10-2 2 2 2"/><path d="m14 14 2-2-2-2"/></svg> ),
  Idareetme: () => ( <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0 0 18 0V5"/><path d="M3 12a9 3 0 0 0 18 0"/></svg> ),
        ...
        <div className="module-grid">
          ...
          <div className="module-card" onClick={() => handleNavigate('attendance')}>
            ...
            <div className="card-text">
              ...
              <p>Məktəbəqədər təhsil müəssisələri üzrə gündəlik davamiyyətin qeydiyyatı.</p>
            </div>
          </div>
          ...
          <div className="module-card" onClick={() => handleNavigate('attendance-reports')}>
            ...
            <div className="card-text">
              ...
              <p>Davamiyyət jurnalı üzrə toplanmış məlumatlara baxış və analiz.</p>
            </div>
          </div>
            ...
            <>
              <div className="module-card" onClick={() => handleNavigate('new-monitoring')}>
                ...
                <div className="card-text">
                  ...
                  <p>Sübut toplama və dinamik suallarla təkmilləşdirilmiş yeni yoxlama forması.</p>
                </div>
              </div>
            ...
            <>
              <div className="module-card admin-card" onClick={() => handleNavigate('admin')}>
                ...
                <div className="card-text">
                  ...
                  <p>Sistemə yeni bağça, qrup və uşaq məlumatlarını daxil etmək.</p>
                </div>
              </div>
              ...
              <div className="module-card admin-card" onClick={() => handleNavigate('settings')}>
                ...
                <div className="card-text">
                  <h4>Tənzimləmələr</h4>
                  <p>İstifadəçi rollarını və sistem tənzimləmələrini idarə etmək.</p>
                </div>
              </div>
            </>
          )}
